...
public class QuadraticProbe<E> {
	...
	public KeyValuePair<E> retrieve(String key) {
		KeyValuePair<E> item = hTable[hash(key) % hTable.length];
		return item;
	}
}